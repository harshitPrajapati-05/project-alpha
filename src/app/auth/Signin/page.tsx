        ...
        <CardContent>
          ...
          render={({ field }) => (
            <FormItem>
               ...
               Password
               {
                 show ? <EyeOpenIcon className='cursor-pointer w-4 h-4 font-semibold text-sky-600' onClick={() => setShow(false)} /> : <EyeClosedIcon className='cursor-pointer w-4 h-4 font-semibold text-sky-600' onClick={() => setShow(true)} />
               }
              </FormLabel>
              <FormControl>
